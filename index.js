...
Car.prototype.accelerate = function(a) {
  this.speed += a;
  console.log(`Автомобіль ${brand} ${model} прискорився до швидкості ${speed} км/год`)
}
...
Car.prototype.brake = function(b) {
  this.speed -= b;
...
Truck.prototype.specific = function(c) {
  if (c > this.towingCapacity) {
...
// Використовуємо bind для зв'язування методу drive з конкретним об'єктом car.
 let result = car.bind(this, drive);
